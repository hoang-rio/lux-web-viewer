...
CATEGORIES = [
    ...
    {"key": CATEGORY_CHARGE, "name_en": "Charge setting", "name_vi": "Cài đặt nạp"},
    {"key": CATEGORY_DISCHARGE, "name_en": "Discharge setting", "name_vi": "Cài đặt xả"},
    {"key": CATEGORY_BATTERY, "name_en": "Battery", "name_vi": "Ắc quy"},
]
...
_ITEMS = [
    ...
    },
    {
        ...
        "name_vi": "Giới hạn SOC ưu tiên nạp",
        "reg": 75,
        "kind": KIND_NUMBER,
        "unit": "%",
        "min": 0,
    ...
    },
    {
        ...
        "name_vi": "Ưu tiên nạp chu kỳ 1 - bắt đầu",
        "reg": 76,
        "kind": KIND_TIME,
    },
    {
        ...
        "name_vi": "Ưu tiên nạp chu kỳ 1 - kết thúc",
        "reg": 77,
        "kind": KIND_TIME,
    },
    {
        ...
        "name_vi": "Ưu tiên nạp chu kỳ 2 - bắt đầu",
        "reg": 78,
        "kind": KIND_TIME,
    },
    {
        ...
        "name_vi": "Ưu tiên nạp chu kỳ 2 - kết thúc",
        "reg": 79,
        "kind": KIND_TIME,
    },
    {
        ...
        "name_vi": "Ưu tiên nạp chu kỳ 3 - bắt đầu",
        "reg": 80,
        "kind": KIND_TIME,
    },
    {
        ...
        "name_vi": "Ưu tiên nạp chu kỳ 3 - kết thúc",
        "reg": 81,
        "kind": KIND_TIME,
    },
    {
